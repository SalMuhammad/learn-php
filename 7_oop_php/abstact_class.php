...
// $produk = new Produk("Naruto", "Nasashi kishimoto", "Shanen Jump", 250000);
...
$cetakSemuaProduk = new CetakInfoProduk();
$cetakSemuaProduk->tambahProduk($produk1);
$cetakSemuaProduk->tambahProduk($produk2);

echo $cetakSemuaProduk->cetak();
